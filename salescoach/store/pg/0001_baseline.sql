-- GENERATED by scripts/gen_pg_baseline.py from store/schema-sales.sql + plugins/*.sql. Do not edit:
-- change the SQLite files and regenerate. Postgres migration 0001: the whole schema at SQLite
-- user_version 6. Later changes are numbered files beside this one (store/pgmigrate.py).
--
...
CREATE TABLE IF NOT EXISTS deals (
  ...
  close_target TEXT,
  updated_at   TEXT,
  value        DOUBLE PRECISION,                        -- learning plugin (outcomes): added by learning.ensure_columns
...
CREATE TABLE IF NOT EXISTS turns (
  ...
  person_id       TEXT,
  t_start         DOUBLE PRECISION,                     -- seconds from call start
  t_end           DOUBLE PRECISION,
  text            TEXT NOT NULL,
  asr_logprob     DOUBLE PRECISION,
...
CREATE TABLE IF NOT EXISTS pattern_observations (
  ...
  confidence       TEXT,
  value            DOUBLE PRECISION,                 -- seller_series only
  outcome_kind     TEXT,
  outcome_value    TEXT,
  seller_id        TEXT,
...
CREATE TABLE IF NOT EXISTS nudges (
  ...
  t_call            DOUBLE PRECISION NOT NULL,          -- seconds since call start: shown at, or retired at
  raised_t          DOUBLE PRECISION,                   -- when the candidate was raised
...
CREATE TABLE IF NOT EXISTS coach_state (
  ...
  call_id    TEXT NOT NULL,
  session    TEXT NOT NULL,
  t_call     DOUBLE PRECISION NOT NULL,
  json       TEXT NOT NULL,
  created_at TEXT NOT NULL
);
